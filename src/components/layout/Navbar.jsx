    ...
    <nav className="bg-white border-b border-gray-100 rounded-b-[16px]">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-[70px] md:h-[90px]">
          ...
          {/* Navigation Links */}
          <div className="hidden lg:flex items-center gap-4 xl:gap-6 h-[64px] justify-center">
            <a
              href="#specialties"
              className="text-[#121212] font-changa text-lg xl:text-2xl font-semibold hover:text-[#468EEC] transition-colors whitespace-nowrap"
            >
              التخصصات
            </a>
            ...
            <a
              href="#home"
              className="text-[#468EEC] font-changa text-lg xl:text-2xl font-semibold border-b-2 border-[#468EEC] pb-2 whitespace-nowrap"
            >
              الرئيسية
            </a>
          </div>
          ...
          <div className="flex items-center">
            <img
              src={rafiqLogo}
              alt="رفيق"
              className="h-10 md:h-12 lg:h-[55px] w-auto"
            />
          </div>
